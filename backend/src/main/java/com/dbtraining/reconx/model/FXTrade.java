...
public final class FXTrade implements TradeType {
    ...
    public static final class Builder {
        ...
        /**
         * Builds an immutable FX trade after checking currencies and commercial invariants.
         *
         * @return a non-null, validated FX trade
         * @throws NullPointerException if a required builder value was not supplied
         * @throws IllegalStateException if currencies match or a monetary value is not positive
         */
